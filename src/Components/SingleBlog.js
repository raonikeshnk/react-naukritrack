...
import { app } from "../Components/Firebase/firebase"; // Ensure this is correctly configured
   ...
   useEffect(() => {
      const fetchBlog = async () => {
         ...
         try {
            ...
            if (blogSnap.exists()) {
               console.log("Blog Data:", blogSnap.data()); // ✅ Log fetched data
                  ...
                  <div className="col-lg-8 posts-list">
                     <div className="single-post">
                        <div className="feature-img">
                           <img className="img-fluid" src={blog.image || "assets/img/blog/single_blog_1.png"} alt={blog.title} />
                        </div>
                        <div className="blog_details">
                           ...
                           <ul className="blog-info-link mt-3 mb-4">
                              <li>
                                 <a href="#">
                                    <i className="fa fa-user"></i> {blog.category || "Uncategorized"}
                                 </a>
                              </li>
                              <li>
                                 <a href="#">
                                    <i className="fa fa-comments"></i> {blog.comments?.length || 0} Comments
                                 </a>
                              </li>
                           </ul>
